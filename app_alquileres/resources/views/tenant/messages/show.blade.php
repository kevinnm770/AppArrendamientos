            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('tenant.messages.index')}}">Mensajes</a></li>
    ...
    <div class="card chat-app">
        <div class="row g-0 h-100">
            ...
            <div class="col-12 col-md-8 chat-panel" id="chat-panel"
                data-poll-url="{{ route('tenant.messages.poll', $agreement->id) }}"
                data-send-url="{{ route('tenant.messages.store', $agreement->id) }}"
                data-history-url="{{ route('tenant.messages.history', $agreement->id) }}"
                data-update-url-base="{{ url('tenant/messages/'.$agreement->id) }}"
                data-has-more="{{ $hasMoreMessages ? '1' : '0' }}">
                <div class="p-3 border-bottom d-flex align-items-center gap-2">
                    <a href="{{ route('tenant.messages.index') }}" class="chat-back-btn d-md-none flex-shrink-0" title="Volver a conversaciones">
